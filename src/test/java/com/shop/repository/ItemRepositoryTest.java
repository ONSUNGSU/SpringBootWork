...
public class ItemRepositoryTest {
    ...
    */
    ...
    // 과제
    // 1. price가 10003에서 10006사이의 값 출력
    /*
    @Test
    @DisplayName("가격이 10003에서 10006사이 값")
    public void findByPriceGreaterThanAndPriceLessThanTest(){
        this.createItemList();
        List<Item> itemList = itemRepository.findByPriceGreaterThanAndPriceLessThan(10002,10007);
        for(Item item : itemList){
            System.out.println(item.toString());
        }
    }
    ...
    public void findByIdGreaterThanTest(){
        this.createItemList();
        List<Item> itemList = itemRepository.findByIdGreaterThan(5);
        for(Item item : itemList){
            System.out.println(item.toString());
        }
    }
    ...
    */
    ...
    @Test
    @DisplayName("상품 Qierydsl 조회 테스트 2")
